...
morshed = admin.create_account('morshed', 500)

arif = admin.create_account('arif', 100)

morshed.deposit(bank, 10000)

print(morshed.check_balance())
print(arif.check_balance())

morshed.withdraw(bank, 1000)
morshed.transfer(arif, 500)

admin.enable_loan_feature()

morshed.take_loan(bank, 100)
...
transaction_history = morshed.get_transaction_history()
